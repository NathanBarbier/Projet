    ...
    <div class="row w-100 mx-auto px-3" style="height: 100%;">
        <div class="col-sm-12 col-md-7 col-lg-8 mt-3 position-relative" style="height:87%; height:max-content">
            ...
            <div id="current-projects-col" class="row mx-3 collapse show mb-3">
                ...
                <div style="height: 90%; overflow: auto">
                    ...
                    if(count($Projects) > 0) {
                        ...
                        <div class="pb-3 mb-5 border-lg" style="height: 75vh;">
                            ...
                            <div class="row mt-4 justify-content-around">
                                <div class="sticker col-4 text-center">
                                    <b>Nb membres</b>
                                    <p class="text-center"><?= count($Project->getUsers()) ?></p>
                                    <br>
                                </div>
            ...
            <div id="account-delete-confirmation" class="sticker collapse text-center mx-auto h-100 pt-3">
                ...
                <a href="<?= CONTROLLERS_URL ?>membres/tableauDeBord.php?action=accountDelete" class="btn btn-outline-danger w-50 mt-4">Supprimer</a>
