...
$envoi = GETPOST('envoi');
$oldPwd = htmlspecialchars(GETPOST('oldpwd'), ENT_NOQUOTES|ENT_SUBSTITUTE, "UTF-8");
$newPwd = htmlspecialchars(GETPOST('newpwd'), ENT_NOQUOTES|ENT_SUBSTITUTE, "UTF-8");
$newPwd2 = htmlspecialchars(GETPOST('newpwd2'), ENT_NOQUOTES|ENT_SUBSTITUTE, "UTF-8");
