...
function loadMore()
{
    $("#load-more").off('click').on('click', function() {
        ...
        $.ajax({
            async: true,
            url: AJAX_URL+"admin/listeProjets.php?action=loadmore&offset="+offset,
                                ...
                                '<div class="col-3 text-center mx-auto">',
                                    ...
                                    '<div class="row">',
                                        '<div class="col-12 col-lg-6">',
                                            '<a href="'+ CONTROLLERS_URL +'admin/detailsProjet.php?idProject='+ project.rowid +'" class="w-100 custom-button info btn-sm mt-1 px-1 pt-2 double-button-responsive">',
                                                'Détails',
                                            '</a>',
                                        '</div>',
                                        '<div class="col-12 col-lg-6">',
