...
<div class="container">
    ...
    <div class="row">
        <form class="col-md-12 col-lg-6 mx-auto border-lg bg-white px-4 pb-3" method="POST" action="<?= CONTROLLERS_URL?>visitor/signup.php">
            ...
            <div class="form-check mt-3">
                ...
                <label class="form-check-label" for="consent-check">En cochant cette case vous acceptez nos <a class="custom-link" href="<?= VIEWS_URL ?>visitor/tcu.php" target="_blank">Conditions générales</a> et confirmez accepter le traitement de vos données</label>
            </div>
            ...
            <div class="form-group text-center mt-2">
                ...
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-5 col-lg-6 col-xl-5 mx-auto">
                        <a href="<?= CONTROLLERS_URL ?>visitor/login.php" class="w-100 custom-button info pt-2 px-1 mt-3">Connectez-vous</a>
                    </div>
                </div>
            </div>
        </form>
