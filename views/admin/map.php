...
<div class="row position-relative bg-white" style="height: 100%;">
    ...
    <!-- Back Page -->
    <a href="<?= CONTROLLERS_URL ?>admin/projectDashboard.php?idProject=<?= $Project->getRowid() ?>" ><i class="btn btn-outline-dark bi bi-box-arrow-left position-absolute start-0 top-0 mt-2 me-2 w-auto before"></i></a>
