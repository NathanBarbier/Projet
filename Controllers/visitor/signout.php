...
$page = "controllers/visitor/signout.php";
...
if($idUser && $idOrganization) {
    ...
    LogHistory::create($User->getRowid(), 'disconnect', 'user', $User->getRowid(), null, null, null, null, $User->getFk_organization(), "INFO", null, $ip, $page);
}
session_destroy();
