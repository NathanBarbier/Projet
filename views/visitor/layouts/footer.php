			...
			<div class="modal fade position-absolute" id="cookiedetailsmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel2" aria-hidden="true">
				<div class="modal-dialog top-15">
					<div class="modal-content">
						<div class="modal-body">
		...
		<footer class="w-100 bg-dark text-center pt-2 footer">
			<a class="custom-link" style="font-size: large;" href="<?= VIEWS_URL ?>visitor/tcu.php">Conditions générales d'utilisation</a>
