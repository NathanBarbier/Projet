    ...
    { ?>
        <nav id="top-navbar" class="navbar navbar-dark bg-dark w-100 pt-1 before" style="height: 55px;">
            ...
            <div class="w-50 pb-3" style="float: right;">
                ...
                <!-- DISCONNECT -->
                <a class="btn btn-sm me-2 mt-1 rounded sidebar-btn danger" style="float: right;" href="<?= CONTROLLERS_URL ?>visitor/signout.php">Déconnexion</a>
            </div>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <div id="collaborateursCollapse" class="collapse">
                                    <ul class="list-unstyled">
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/associateMenu.php">Vue d'ensemble</a></li>
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/userSignup.php">Inscriptions</a></li>
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/associateList.php">Liste des membres</a></li>
                                    </ul>
                                </div>
                            </li>
                            <!-- ORGANISATION -->
                            <li class="mt-2">
                                ...
                                <div id="organisationCollapse" class="collapse">
                                    <ul class="list-unstyled">
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/organizationDashboard.php">Gestion organisation</a></li>
                                    </ul>
                                </div>
                            ...
                            <li class="mt-2">
                                ...
                                <div id="projetsCollapse" class="collapse">
                                    <ul class="list-unstyled">
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/projectMenu.php">Vue d'ensemble</a></li>
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/projectCreation.php">Création de projets</a></li>
                                        <li><a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/projectList.php">Liste des projets</a></li>
                                    </ul>
                                </div>
                    ...
                    <nav class="w-100 h-100">
                        <ul class="list-unstyled position-relative" style="height: 100%;">
                            ...
                            <div class="overflow-y" style="height: 100%; max-height: 85vh">
                                ...
                                <li class="mt-3">
                                    ...
                                    <div id="projetsCollapse" class="collapse">
                                        <ul class="list-unstyled">
                                            <li>
                                                <a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/projectMenu.php">
                                                    Vue d'ensemble
                                                </a>
                                            </li>
                                            <li>
                                                <a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/projectCreation.php">
                                                    Création de projets
                                                </a>
                                            </li>
                                            <li>
                                                <a class="btn px-3 mt-2 rounded w-90 mt-2 sidebar-btn" href="<?= CONTROLLERS_URL ?>admin/projectList.php">
                                                    Liste des projets
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <li class="mb-4 position-absolute bottom-0 w-100">
                                <a class="btn h-12 px-3 mt-2 rounded w-90 sidebar-btn danger" href="<?= CONTROLLERS_URL ?>visitor/signout.php">Déconnexion</a>
                            </li>
