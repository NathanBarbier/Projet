            ...
            <div class="text-center mt-2">
                ...
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-5 col-lg-6 col-xl-5 mx-auto">
                        <a href="signup.php" class="w-100 custom-button info pt-2 px-1 mt-3">Inscrivez-vous</a>
                    </div>
                </div>
            </div>
        </form>
...
<script type="text/Javascript" src="<?= JS_URL ?>visitor/login.min.js" defer></script>
