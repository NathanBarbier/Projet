...
<div class="container mt-5">
    ...
    <div class="sticker h-auto mt-3 pt-3 pb-5 w-75 mx-auto text-center">
        ...
        <a href="<?= CONTROLLERS_URL ?>general/needConsent.php?action=giveConsent" id="give-consent" class="btn btn-outline-success w-25">Accepter</a>

        <p class="mt-5"><b>Je refuse le traitement de mes données. (Votre compte sera alors supprimé)</b></p>
        <a href="<?= CONTROLLERS_URL ?>general/needConsent.php?action=refuseConsent" id="refuse-consent" class="btn btn-outline-danger w-25">Refuser</a>
    </div>
</div>
