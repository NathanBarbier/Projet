...
<div class="mx-3 text-center col-sm-12 col-md-8 mx-auto bg-light p-5" style="border-radius: 15px;">
    <h1 class="border-bottom">Conditions générales d'utilisation</h1>

    <h4 class="mt-5 underline">Article 1 : Objet</h4>
            
    <p>
        Les présentes CGU ou Conditions Générales d’Utilisation encadrent juridiquement l’utilisation des services du site <u>www.storieshelper.ipssi-sio.fr</u> (ci-après dénommé « Stories Helper »).
    </p>
    <p>
    ...
    <hr class="mt-3">
    <br>
    <h4 class="underline">Article 2 : Mentions légales</h4>
    <p>
        L’édition du site <u>www.storieshelper.ipssi-sio.fr</u> est assurée par la société MacroSoft SAS inscrite au RCS sous le numéro 685 342 597, dont le siège social est localisé au 15 2 bis avenue de Paris, 78000, Versailles, France Métropolitaine.
    </p>
    <p>
        L’hébergeur du site <u>www.storieshelper.ipssi-sio.fr</u> est la société OVH, dont le siège social est localisé au 2 rue Kellermann, 59100 Roubaix, France.
    </p>

    <br>
    <hr>
    <br>
    <h4 class="underline">Article 3 : Accès au site</h4>
    <p>
        Le site <u>www.storieshelper.ipssi-sio.fr</u> permet d’accéder gratuitement aux services suivants :
    </p>
    <ul>
        <li>Gestion des projets de l'organisation.</li>
        <li>Gestion des membres de l'organisation.</li>
        <li>En tant qu'utilisateur gestion de ses projets / tâches.</li>
    </ul>
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 4 : Collecte des données</h4>
    <p>
    ...
    <ul>
        <li>Les informations liées à l'organisation concernée.</li>
        <li>Son profil utilisateur.</li>
    </ul>

    <br>
    <hr>
    <br>
    <h4 class="underline">Article 5 : Propriété intellectuelle</h4>
    <p>
        Les marques, logos ainsi que les contenus du site <u>www.storieshelper.ipssi-sio.fr</u> (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.
    </p>
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 6 : Responsabilité</h4>      
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 7 : Liens hypertextes</h4>
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 8 : Cookies</h4>
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 9 : Publication par l’Utilisateur</h4>
    <p>
        Le site Stories Helper permet aux membres de publier des commentaires.
    </p>
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 10 : Durée du contrat</h4>
    <p>
    ...
    <hr>
    <br>
    <h4 class="underline">Article 11 : Droit applicable et juridiction compétente</h4>
    <p>
